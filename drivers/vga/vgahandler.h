...
This is the VGA text and graphics header file for FloppaOS. Text output is completely safe and implemented; however, the graphics are very much in a beginning state of development.
